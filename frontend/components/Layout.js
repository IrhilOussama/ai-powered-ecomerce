...
import { FaSearch, FaShoppingCart, FaUser, FaFacebook, FaTwitter, FaInstagram, FaLinkedin, FaPaperPlane, FaCcVisa, FaCcMastercard, FaCcPaypal, FaCcAmazonPay, FaGooglePlay, FaArrowDown, FaArrowUp } from 'react-icons/fa';
        ...
        <div className={styles.headerContent}>
          <div className={styles.topBar}>
            <div className={styles.logoSection}>
              <Link href="/">
                <div className={styles.logo}>AI Store</div>
              </Link>
            </div>
